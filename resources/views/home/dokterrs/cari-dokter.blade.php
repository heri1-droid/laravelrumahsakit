...
<div class="page-section" style="background-image: url({{asset('img/layanan/6.jpg')}}); margin-top: -20px;">
    ...
    <div class="container py-4" data-aos="fade-up" data-aos-duration="900">
        <div class="row">
            <div class="col-md-3 mb-4">
                <div class="card text-center card-doktor-page">
                    <div class="img mb-2">
